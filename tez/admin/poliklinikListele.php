<?php
  ...
  $sorgu=$db->prepare("SELECT * FROM poliklinik ");
  $sorgu->execute();
  $poliklinik=$sorgu->fetchAll(PDO::FETCH_OBJ);
...
<body class="">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="poliklinikListele.php" class="nav-link active" aria-current="page">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"></use></svg>
          Polikilinikler
        </a>
      </li>
   ...
   <div class="col-9">
       <div class="card mt-5">
          <div class="card-header">Poliklinikler</div>
           <div class="card-body">
               <table class="table table-hover">
            <tr>
    <th>Poliklinik ID</th>
    <th>Poliklinik Adı</th>
    <th>Poliklinik Tanım</th>
    
    
  </tr>
  <?php
         foreach($poliklinik as $b){  
  ?>
    
  <tr>
      <td><?=$b->poliklinikId?></td>
      <td><?=$b->poliklinikadi?></td>
      <td><?=$b->poliklinikaciklama?></td>
