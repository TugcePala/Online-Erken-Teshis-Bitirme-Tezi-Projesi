<?php
  ...
  $sorgu=$db->prepare("SELECT * FROM hastaliklar ");
  $sorgu->execute();
...
<body class="">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
     <li class="nav-item">
      ...
      <li>
        <a href="hastaliklarListele.php" class="nav-link active" aria-current="page">
      ...
      <li>
        <a href="belirtiListele.php" class="nav-link link-dark">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"></use></svg>
          Belirtiler
        </a>
      </li>
   ...
   <div class="col-9">
       <div class="card mt-5">
          <div class="card-header">Hastalıklar</div>
           <div class="card-body">
               <table class="table table-hover">
            <tr>
    <th>Hastalik ID</th>
    <th>Hastalik Adı</th>
    <th>Hastalık Tanım</th>
    <th>İlgili Poliklinik</th>
    <th></th>
    
  </tr>
  <?php
         foreach($hastaliklar as $h){  
  ?>
    
  <tr>
      <td><?=$h->hastalikId?></td>
      <td><?=$h->hastalikadi?></td>
      <td><?=$h->hastaliktanım?></td>
      <td><?=$h->poliklinik_id?></td>
      <td><a href="hastalik_detay.php?hastalik_id=<?=$h->hastalikId?>" class="btn btn-primary">Detay</a></td>
